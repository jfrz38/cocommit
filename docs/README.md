...
- Current work: pre-release roadmap, Iterations 10 release control, 11 CLI contract and diagnostics, and 12 terminal and input hardening complete; Iteration 13 staged-change context is next
