...
impl Edit {
    fn request(self) -> InputRequest {
        match self {
            ...
            Self::PreviousChar => InputRequest::GoToPrevChar,
            Self::NextChar => InputRequest::GoToNextChar,
            Self::PreviousWord => InputRequest::GoToPrevWord,
            Self::NextWord => InputRequest::GoToNextWord,
